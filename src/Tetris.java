...
public class Tetris extends ApplicationAdapter
{
    ...
    public void create(){
        ...
        board = new Color[Global.VISIBLE_ROWS][Global.COLS];
    ...
    private void drawGrid() {
        ...
        for (int y = 0; y < Global.VISIBLE_ROWS; y++) {
            for (int x = 0; x < Global.COLS; x++) {
                ...
                renderer.rect(Global.FIELD_X + 1 + x * (Global.SQUARE_SIZE + 2), 100 + 1 + y * (Global.SQUARE_SIZE + 2), Global.SQUARE_SIZE, Global.SQUARE_SIZE);
            }
        }
        renderer.end();
    }
